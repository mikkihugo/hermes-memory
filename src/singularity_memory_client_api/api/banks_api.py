...
from singularity_memory_client_api.api_client import ApiClient, RequestSerialized
from singularity_memory_client_api.api_response import ApiResponse
from singularity_memory_client_api.rest import RESTResponseType
...
class BanksApi:
    ...
    async def update_bank_config(
        ...
        Update configuration overrides for a bank. Only hierarchical fields can be overridden (LLM settings, retention parameters, etc.). Keys can be provided in Python field format (llm_provider) or environment variable format (SINGULARITY_LLM_PROVIDER).

"""
Banner display for Singularity Memory startup.
...
def print_banner():
    """Print the Singularity Memory startup banner."""
    print(LOGO)
    tagline = gradient_text("Singularity Memory: Persistent Memory for AI Agents")
    print(f"\n  {tagline}\n")
...
def print_startup_info(
    ...
    print(color_start("Starting Singularity Memory..."))
    if version:

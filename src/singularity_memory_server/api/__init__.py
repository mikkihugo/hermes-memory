"""
Unified API module for Singularity Memory.
...
def create_app(
    ...
    """
    Create and configure the unified Singularity Memory application.
    ...
    if mcp_api_enabled:
        try:
            ...
            logger.error("Install with: pip install singularity-memory[mcp]")
            raise
    ...
    if http_api_enabled:
        ...
        app = FastAPI(title="Singularity Memory", version="0.0.7")

"""
Centralized configuration for Singularity Memory.
...
class StaticConfigProxy:
    """
    Proxy that wraps SingularityConfig and only allows access to static (non-configurable) fields.
    ...
    def __init__(self, config: "SingularityConfig"):
        ...
        object.__setattr__(self, "_configurable_fields", SingularityConfig.get_configurable_fields())
...
def normalize_config_key(key: str) -> str:
    ...
    Examples:
        SINGULARITY_LLM_PROVIDER -> llm_provider
        LLM_MODEL -> llm_model
...
def normalize_config_dict(config: dict[str, Any]) -> dict[str, Any]:
    ...
    - Env var format: {"SINGULARITY_LLM_PROVIDER": "openai"}
...
ENV_DATABASE_URL = "SINGULARITY_DATABASE_URL"
ENV_MIGRATION_DATABASE_URL = "SINGULARITY_MIGRATION_DATABASE_URL"
ENV_DATABASE_SCHEMA = "SINGULARITY_DATABASE_SCHEMA"
ENV_LLM_PROVIDER = "SINGULARITY_LLM_PROVIDER"
ENV_LLM_API_KEY = "SINGULARITY_LLM_API_KEY"
ENV_LLM_MODEL = "SINGULARITY_LLM_MODEL"
ENV_LLM_BASE_URL = "SINGULARITY_LLM_BASE_URL"
ENV_LLM_MAX_CONCURRENT = "SINGULARITY_LLM_MAX_CONCURRENT"
ENV_LLM_MAX_RETRIES = "SINGULARITY_LLM_MAX_RETRIES"
ENV_LLM_INITIAL_BACKOFF = "SINGULARITY_LLM_INITIAL_BACKOFF"
ENV_LLM_MAX_BACKOFF = "SINGULARITY_LLM_MAX_BACKOFF"
ENV_LLM_TIMEOUT = "SINGULARITY_LLM_TIMEOUT"
ENV_LLM_GROQ_SERVICE_TIER = "SINGULARITY_LLM_GROQ_SERVICE_TIER"
ENV_LLM_OPENAI_SERVICE_TIER = "SINGULARITY_LLM_OPENAI_SERVICE_TIER"
ENV_LLM_EXTRA_BODY = "SINGULARITY_LLM_EXTRA_BODY"
...
ENV_RETAIN_LLM_PROVIDER = "SINGULARITY_RETAIN_LLM_PROVIDER"
ENV_RETAIN_LLM_API_KEY = "SINGULARITY_RETAIN_LLM_API_KEY"
ENV_RETAIN_LLM_MODEL = "SINGULARITY_RETAIN_LLM_MODEL"
ENV_RETAIN_LLM_BASE_URL = "SINGULARITY_RETAIN_LLM_BASE_URL"
ENV_RETAIN_LLM_MAX_CONCURRENT = "SINGULARITY_RETAIN_LLM_MAX_CONCURRENT"
ENV_RETAIN_LLM_MAX_RETRIES = "SINGULARITY_RETAIN_LLM_MAX_RETRIES"
ENV_RETAIN_LLM_INITIAL_BACKOFF = "SINGULARITY_RETAIN_LLM_INITIAL_BACKOFF"
ENV_RETAIN_LLM_MAX_BACKOFF = "SINGULARITY_RETAIN_LLM_MAX_BACKOFF"
ENV_RETAIN_LLM_TIMEOUT = "SINGULARITY_RETAIN_LLM_TIMEOUT"

ENV_REFLECT_LLM_PROVIDER = "SINGULARITY_REFLECT_LLM_PROVIDER"
ENV_REFLECT_LLM_API_KEY = "SINGULARITY_REFLECT_LLM_API_KEY"
ENV_REFLECT_LLM_MODEL = "SINGULARITY_REFLECT_LLM_MODEL"
ENV_REFLECT_LLM_BASE_URL = "SINGULARITY_REFLECT_LLM_BASE_URL"
ENV_REFLECT_LLM_MAX_CONCURRENT = "SINGULARITY_REFLECT_LLM_MAX_CONCURRENT"
ENV_REFLECT_LLM_MAX_RETRIES = "SINGULARITY_REFLECT_LLM_MAX_RETRIES"
ENV_REFLECT_LLM_INITIAL_BACKOFF = "SINGULARITY_REFLECT_LLM_INITIAL_BACKOFF"
ENV_REFLECT_LLM_MAX_BACKOFF = "SINGULARITY_REFLECT_LLM_MAX_BACKOFF"
ENV_REFLECT_LLM_TIMEOUT = "SINGULARITY_REFLECT_LLM_TIMEOUT"

ENV_CONSOLIDATION_LLM_PROVIDER = "SINGULARITY_CONSOLIDATION_LLM_PROVIDER"
ENV_CONSOLIDATION_LLM_API_KEY = "SINGULARITY_CONSOLIDATION_LLM_API_KEY"
ENV_CONSOLIDATION_LLM_MODEL = "SINGULARITY_CONSOLIDATION_LLM_MODEL"
ENV_CONSOLIDATION_LLM_BASE_URL = "SINGULARITY_CONSOLIDATION_LLM_BASE_URL"
ENV_CONSOLIDATION_LLM_MAX_CONCURRENT = "SINGULARITY_CONSOLIDATION_LLM_MAX_CONCURRENT"
ENV_CONSOLIDATION_LLM_MAX_RETRIES = "SINGULARITY_CONSOLIDATION_LLM_MAX_RETRIES"
ENV_CONSOLIDATION_LLM_INITIAL_BACKOFF = "SINGULARITY_CONSOLIDATION_LLM_INITIAL_BACKOFF"
ENV_CONSOLIDATION_LLM_MAX_BACKOFF = "SINGULARITY_CONSOLIDATION_LLM_MAX_BACKOFF"
ENV_CONSOLIDATION_LLM_TIMEOUT = "SINGULARITY_CONSOLIDATION_LLM_TIMEOUT"

ENV_EMBEDDINGS_PROVIDER = "SINGULARITY_EMBEDDINGS_PROVIDER"
ENV_EMBEDDINGS_LOCAL_MODEL = "SINGULARITY_EMBEDDINGS_LOCAL_MODEL"
ENV_EMBEDDINGS_LOCAL_FORCE_CPU = "SINGULARITY_EMBEDDINGS_LOCAL_FORCE_CPU"
ENV_EMBEDDINGS_LOCAL_TRUST_REMOTE_CODE = "SINGULARITY_EMBEDDINGS_LOCAL_TRUST_REMOTE_CODE"
ENV_EMBEDDINGS_TEI_URL = "SINGULARITY_EMBEDDINGS_TEI_URL"
ENV_EMBEDDINGS_OPENAI_API_KEY = "SINGULARITY_EMBEDDINGS_OPENAI_API_KEY"
ENV_EMBEDDINGS_OPENAI_MODEL = "SINGULARITY_EMBEDDINGS_OPENAI_MODEL"
ENV_EMBEDDINGS_OPENAI_BASE_URL = "SINGULARITY_EMBEDDINGS_OPENAI_BASE_URL"

# Gemini/Vertex AI embeddings configuration
ENV_EMBEDDINGS_GEMINI_API_KEY = "SINGULARITY_EMBEDDINGS_GEMINI_API_KEY"
ENV_EMBEDDINGS_GEMINI_MODEL = "SINGULARITY_EMBEDDINGS_GEMINI_MODEL"
ENV_EMBEDDINGS_GEMINI_OUTPUT_DIMENSIONALITY = "SINGULARITY_EMBEDDINGS_GEMINI_OUTPUT_DIMENSIONALITY"
ENV_EMBEDDINGS_VERTEXAI_PROJECT_ID = "SINGULARITY_EMBEDDINGS_VERTEXAI_PROJECT_ID"
ENV_EMBEDDINGS_VERTEXAI_REGION = "SINGULARITY_EMBEDDINGS_VERTEXAI_REGION"
ENV_EMBEDDINGS_VERTEXAI_SERVICE_ACCOUNT_KEY = "SINGULARITY_EMBEDDINGS_VERTEXAI_SERVICE_ACCOUNT_KEY"

# Cohere configuration (separate for embeddings and reranker)
ENV_EMBEDDINGS_COHERE_API_KEY = "SINGULARITY_EMBEDDINGS_COHERE_API_KEY"
ENV_EMBEDDINGS_COHERE_MODEL = "SINGULARITY_EMBEDDINGS_COHERE_MODEL"
ENV_EMBEDDINGS_COHERE_BASE_URL = "SINGULARITY_EMBEDDINGS_COHERE_BASE_URL"
ENV_RERANKER_COHERE_API_KEY = "SINGULARITY_RERANKER_COHERE_API_KEY"
ENV_RERANKER_COHERE_MODEL = "SINGULARITY_RERANKER_COHERE_MODEL"
ENV_RERANKER_COHERE_BASE_URL = "SINGULARITY_RERANKER_COHERE_BASE_URL"

# OpenRouter configuration (embeddings and reranker)
ENV_OPENROUTER_API_KEY = "SINGULARITY_OPENROUTER_API_KEY"
ENV_EMBEDDINGS_OPENROUTER_API_KEY = "SINGULARITY_EMBEDDINGS_OPENROUTER_API_KEY"
ENV_EMBEDDINGS_OPENROUTER_MODEL = "SINGULARITY_EMBEDDINGS_OPENROUTER_MODEL"
ENV_RERANKER_OPENROUTER_API_KEY = "SINGULARITY_RERANKER_OPENROUTER_API_KEY"
ENV_RERANKER_OPENROUTER_MODEL = "SINGULARITY_RERANKER_OPENROUTER_MODEL"

# Deprecated: Legacy shared Cohere API key (for backward compatibility)
ENV_COHERE_API_KEY = "SINGULARITY_COHERE_API_KEY"

# LiteLLM configuration (separate for embeddings and reranker)
ENV_EMBEDDINGS_LITELLM_API_BASE = "SINGULARITY_EMBEDDINGS_LITELLM_API_BASE"
ENV_EMBEDDINGS_LITELLM_API_KEY = "SINGULARITY_EMBEDDINGS_LITELLM_API_KEY"
ENV_EMBEDDINGS_LITELLM_MODEL = "SINGULARITY_EMBEDDINGS_LITELLM_MODEL"
ENV_RERANKER_LITELLM_API_BASE = "SINGULARITY_RERANKER_LITELLM_API_BASE"
ENV_RERANKER_LITELLM_API_KEY = "SINGULARITY_RERANKER_LITELLM_API_KEY"
ENV_RERANKER_LITELLM_MODEL = "SINGULARITY_RERANKER_LITELLM_MODEL"
ENV_RERANKER_LITELLM_MAX_TOKENS_PER_DOC = "SINGULARITY_RERANKER_LITELLM_MAX_TOKENS_PER_DOC"

# LiteLLM SDK configuration (direct API access, no proxy needed)
ENV_EMBEDDINGS_LITELLM_SDK_API_KEY = "SINGULARITY_EMBEDDINGS_LITELLM_SDK_API_KEY"
ENV_EMBEDDINGS_LITELLM_SDK_MODEL = "SINGULARITY_EMBEDDINGS_LITELLM_SDK_MODEL"
ENV_EMBEDDINGS_LITELLM_SDK_API_BASE = "SINGULARITY_EMBEDDINGS_LITELLM_SDK_API_BASE"
ENV_EMBEDDINGS_LITELLM_SDK_OUTPUT_DIMENSIONS = "SINGULARITY_EMBEDDINGS_LITELLM_SDK_OUTPUT_DIMENSIONS"
ENV_EMBEDDINGS_LITELLM_SDK_ENCODING_FORMAT = "SINGULARITY_EMBEDDINGS_LITELLM_SDK_ENCODING_FORMAT"
ENV_RERANKER_LITELLM_SDK_API_KEY = "SINGULARITY_RERANKER_LITELLM_SDK_API_KEY"
ENV_RERANKER_LITELLM_SDK_MODEL = "SINGULARITY_RERANKER_LITELLM_SDK_MODEL"
ENV_RERANKER_LITELLM_SDK_API_BASE = "SINGULARITY_RERANKER_LITELLM_SDK_API_BASE"

# Deprecated: Legacy shared LiteLLM config (for backward compatibility)
ENV_LITELLM_API_BASE = "SINGULARITY_LITELLM_API_BASE"
ENV_LITELLM_API_KEY = "SINGULARITY_LITELLM_API_KEY"

ENV_RERANKER_PROVIDER = "SINGULARITY_RERANKER_PROVIDER"
ENV_RERANKER_LOCAL_MODEL = "SINGULARITY_RERANKER_LOCAL_MODEL"
ENV_RERANKER_LOCAL_FORCE_CPU = "SINGULARITY_RERANKER_LOCAL_FORCE_CPU"
ENV_RERANKER_LOCAL_MAX_CONCURRENT = "SINGULARITY_RERANKER_LOCAL_MAX_CONCURRENT"
ENV_RERANKER_LOCAL_TRUST_REMOTE_CODE = "SINGULARITY_RERANKER_LOCAL_TRUST_REMOTE_CODE"
ENV_RERANKER_LOCAL_FP16 = "SINGULARITY_RERANKER_LOCAL_FP16"
ENV_RERANKER_LOCAL_BUCKET_BATCHING = "SINGULARITY_RERANKER_LOCAL_BUCKET_BATCHING"
ENV_RERANKER_LOCAL_BATCH_SIZE = "SINGULARITY_RERANKER_LOCAL_BATCH_SIZE"
ENV_RERANKER_TEI_URL = "SINGULARITY_RERANKER_TEI_URL"
ENV_RERANKER_TEI_BATCH_SIZE = "SINGULARITY_RERANKER_TEI_BATCH_SIZE"
ENV_RERANKER_TEI_MAX_CONCURRENT = "SINGULARITY_RERANKER_TEI_MAX_CONCURRENT"
ENV_RERANKER_TEI_HTTP_TIMEOUT = "SINGULARITY_RERANKER_TEI_HTTP_TIMEOUT"
ENV_RERANKER_MAX_CANDIDATES = "SINGULARITY_RERANKER_MAX_CANDIDATES"
ENV_RERANKER_FLASHRANK_MODEL = "SINGULARITY_RERANKER_FLASHRANK_MODEL"
ENV_RERANKER_FLASHRANK_CACHE_DIR = "SINGULARITY_RERANKER_FLASHRANK_CACHE_DIR"

# ZeroEntropy configuration (reranker only)
ENV_RERANKER_ZEROENTROPY_API_KEY = "SINGULARITY_RERANKER_ZEROENTROPY_API_KEY"
ENV_RERANKER_ZEROENTROPY_MODEL = "SINGULARITY_RERANKER_ZEROENTROPY_MODEL"
ENV_RERANKER_ZEROENTROPY_BASE_URL = "SINGULARITY_RERANKER_ZEROENTROPY_BASE_URL"

# SiliconFlow configuration (reranker only; Cohere-compatible /rerank endpoint)
ENV_RERANKER_SILICONFLOW_API_KEY = "SINGULARITY_RERANKER_SILICONFLOW_API_KEY"
ENV_RERANKER_SILICONFLOW_MODEL = "SINGULARITY_RERANKER_SILICONFLOW_MODEL"
ENV_RERANKER_SILICONFLOW_BASE_URL = "SINGULARITY_RERANKER_SILICONFLOW_BASE_URL"

# Google Discovery Engine reranker configuration
ENV_RERANKER_GOOGLE_MODEL = "SINGULARITY_RERANKER_GOOGLE_MODEL"
ENV_RERANKER_GOOGLE_PROJECT_ID = "SINGULARITY_RERANKER_GOOGLE_PROJECT_ID"
ENV_RERANKER_GOOGLE_SERVICE_ACCOUNT_KEY = "SINGULARITY_RERANKER_GOOGLE_SERVICE_ACCOUNT_KEY"
...
ENV_LOG_LEVEL = "SINGULARITY_LOG_LEVEL"
ENV_LOG_FORMAT = "SINGULARITY_LOG_FORMAT"
ENV_LOG_JSON_FIELDS = "SINGULARITY_LOG_JSON_FIELDS"
ENV_WORKERS = "SINGULARITY_WORKERS"
ENV_MCP_ENABLED = "SINGULARITY_MCP_ENABLED"
ENV_MCP_ENABLED_TOOLS = "SINGULARITY_MCP_ENABLED_TOOLS"
ENV_MCP_STATELESS = "SINGULARITY_MCP_STATELESS"
ENV_ENABLE_BANK_CONFIG_API = "SINGULARITY_ENABLE_BANK_CONFIG_API"
ENV_DEFAULT_BANK_TEMPLATE = "SINGULARITY_DEFAULT_BANK_TEMPLATE"
ENV_GRAPH_RETRIEVER = "SINGULARITY_GRAPH_RETRIEVER"
ENV_RECALL_MAX_CONCURRENT = "SINGULARITY_RECALL_MAX_CONCURRENT"
ENV_RECALL_CONNECTION_BUDGET = "SINGULARITY_RECALL_CONNECTION_BUDGET"
ENV_RECALL_MAX_QUERY_TOKENS = "SINGULARITY_RECALL_MAX_QUERY_TOKENS"
ENV_MENTAL_MODEL_REFRESH_CONCURRENCY = "SINGULARITY_MENTAL_MODEL_REFRESH_CONCURRENCY"
ENV_LINK_EXPANSION_PER_ENTITY_LIMIT = "SINGULARITY_LINK_EXPANSION_PER_ENTITY_LIMIT"
ENV_LINK_EXPANSION_TIMEOUT = "SINGULARITY_LINK_EXPANSION_TIMEOUT"

# OpenTelemetry tracing configuration
ENV_OTEL_TRACES_ENABLED = "SINGULARITY_OTEL_TRACES_ENABLED"
ENV_OTEL_EXPORTER_OTLP_ENDPOINT = "SINGULARITY_OTEL_EXPORTER_OTLP_ENDPOINT"
ENV_OTEL_EXPORTER_OTLP_HEADERS = "SINGULARITY_OTEL_EXPORTER_OTLP_HEADERS"
ENV_OTEL_SERVICE_NAME = "SINGULARITY_OTEL_SERVICE_NAME"
ENV_OTEL_DEPLOYMENT_ENVIRONMENT = "SINGULARITY_OTEL_DEPLOYMENT_ENVIRONMENT"
ENV_METRICS_INCLUDE_BANK_ID = "SINGULARITY_METRICS_INCLUDE_BANK_ID"

# Vertex AI configuration
ENV_LLM_VERTEXAI_PROJECT_ID = "SINGULARITY_LLM_VERTEXAI_PROJECT_ID"
ENV_LLM_VERTEXAI_REGION = "SINGULARITY_LLM_VERTEXAI_REGION"
ENV_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY = "SINGULARITY_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY"

# Gemini safety settings
ENV_LLM_GEMINI_SAFETY_SETTINGS = "SINGULARITY_LLM_GEMINI_SAFETY_SETTINGS"

# Retain settings
ENV_RETAIN_MAX_COMPLETION_TOKENS = "SINGULARITY_RETAIN_MAX_COMPLETION_TOKENS"
ENV_RETAIN_CHUNK_SIZE = "SINGULARITY_RETAIN_CHUNK_SIZE"
ENV_RETAIN_EXTRACT_CAUSAL_LINKS = "SINGULARITY_RETAIN_EXTRACT_CAUSAL_LINKS"
ENV_RETAIN_EXTRACTION_MODE = "SINGULARITY_RETAIN_EXTRACTION_MODE"
ENV_RETAIN_MISSION = "SINGULARITY_RETAIN_MISSION"
ENV_RETAIN_CUSTOM_INSTRUCTIONS = "SINGULARITY_RETAIN_CUSTOM_INSTRUCTIONS"
ENV_RETAIN_DEFAULT_STRATEGY = "SINGULARITY_RETAIN_DEFAULT_STRATEGY"
ENV_RETAIN_BATCH_TOKENS = "SINGULARITY_RETAIN_BATCH_TOKENS"
ENV_RETAIN_ENTITY_LOOKUP = "SINGULARITY_RETAIN_ENTITY_LOOKUP"
ENV_RETAIN_BATCH_ENABLED = "SINGULARITY_RETAIN_BATCH_ENABLED"
ENV_RETAIN_BATCH_POLL_INTERVAL_SECONDS = "SINGULARITY_RETAIN_BATCH_POLL_INTERVAL_SECONDS"
ENV_RETAIN_CHUNK_BATCH_SIZE = "SINGULARITY_RETAIN_CHUNK_BATCH_SIZE"

# File storage configuration
ENV_FILE_STORAGE_TYPE = "SINGULARITY_FILE_STORAGE_TYPE"
ENV_FILE_STORAGE_S3_BUCKET = "SINGULARITY_FILE_STORAGE_S3_BUCKET"
ENV_FILE_STORAGE_S3_REGION = "SINGULARITY_FILE_STORAGE_S3_REGION"
ENV_FILE_STORAGE_S3_ENDPOINT = "SINGULARITY_FILE_STORAGE_S3_ENDPOINT"
ENV_FILE_STORAGE_S3_ACCESS_KEY_ID = "SINGULARITY_FILE_STORAGE_S3_ACCESS_KEY_ID"
ENV_FILE_STORAGE_S3_SECRET_ACCESS_KEY = "SINGULARITY_FILE_STORAGE_S3_SECRET_ACCESS_KEY"
ENV_FILE_STORAGE_GCS_BUCKET = "SINGULARITY_FILE_STORAGE_GCS_BUCKET"
ENV_FILE_STORAGE_GCS_SERVICE_ACCOUNT_KEY = "SINGULARITY_FILE_STORAGE_GCS_SERVICE_ACCOUNT_KEY"
ENV_FILE_STORAGE_AZURE_CONTAINER = "SINGULARITY_FILE_STORAGE_AZURE_CONTAINER"
ENV_FILE_STORAGE_AZURE_ACCOUNT_NAME = "SINGULARITY_FILE_STORAGE_AZURE_ACCOUNT_NAME"
ENV_FILE_STORAGE_AZURE_ACCOUNT_KEY = "SINGULARITY_FILE_STORAGE_AZURE_ACCOUNT_KEY"
ENV_FILE_PARSER = "SINGULARITY_FILE_PARSER"
ENV_FILE_PARSER_ALLOWLIST = "SINGULARITY_FILE_PARSER_ALLOWLIST"
ENV_FILE_PARSER_IRIS_TOKEN = "SINGULARITY_FILE_PARSER_IRIS_TOKEN"
ENV_FILE_PARSER_IRIS_ORG_ID = "SINGULARITY_FILE_PARSER_IRIS_ORG_ID"
ENV_FILE_CONVERSION_MAX_BATCH_SIZE_MB = "SINGULARITY_FILE_CONVERSION_MAX_BATCH_SIZE_MB"
ENV_FILE_CONVERSION_MAX_BATCH_SIZE = "SINGULARITY_FILE_CONVERSION_MAX_BATCH_SIZE"
ENV_ENABLE_FILE_UPLOAD_API = "SINGULARITY_ENABLE_FILE_UPLOAD_API"
ENV_FILE_DELETE_AFTER_RETAIN = "SINGULARITY_FILE_DELETE_AFTER_RETAIN"

# Observations settings (consolidated knowledge from facts)
ENV_ENABLE_OBSERVATIONS = "SINGULARITY_ENABLE_OBSERVATIONS"
ENV_CONSOLIDATION_BATCH_SIZE = "SINGULARITY_CONSOLIDATION_BATCH_SIZE"
ENV_CONSOLIDATION_MAX_MEMORIES_PER_ROUND = "SINGULARITY_CONSOLIDATION_MAX_MEMORIES_PER_ROUND"
ENV_CONSOLIDATION_LLM_BATCH_SIZE = "SINGULARITY_CONSOLIDATION_LLM_BATCH_SIZE"
ENV_CONSOLIDATION_MAX_TOKENS = "SINGULARITY_CONSOLIDATION_MAX_TOKENS"
ENV_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS = "SINGULARITY_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS"
ENV_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS_PER_OBSERVATION = (
    "SINGULARITY_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS_PER_OBSERVATION"
)
ENV_CONSOLIDATION_MAX_ATTEMPTS = "SINGULARITY_CONSOLIDATION_MAX_ATTEMPTS"
ENV_OBSERVATIONS_MISSION = "SINGULARITY_OBSERVATIONS_MISSION"
ENV_MAX_OBSERVATIONS_PER_SCOPE = "SINGULARITY_MAX_OBSERVATIONS_PER_SCOPE"
ENV_ENABLE_OBSERVATION_HISTORY = "SINGULARITY_ENABLE_OBSERVATION_HISTORY"
ENV_ENABLE_MENTAL_MODEL_HISTORY = "SINGULARITY_ENABLE_MENTAL_MODEL_HISTORY"

# Webhook configuration (global, static - server-level only)
ENV_WEBHOOK_URL = "SINGULARITY_WEBHOOK_URL"
ENV_WEBHOOK_SECRET = "SINGULARITY_WEBHOOK_SECRET"
ENV_WEBHOOK_EVENT_TYPES = "SINGULARITY_WEBHOOK_EVENT_TYPES"
ENV_WEBHOOK_DELIVERY_POLL_INTERVAL_SECONDS = "SINGULARITY_WEBHOOK_DELIVERY_POLL_INTERVAL_SECONDS"

# Built-in llama.cpp configuration (for provider=llamacpp)
ENV_LLAMACPP_MODEL_PATH = "SINGULARITY_LLAMACPP_MODEL_PATH"
ENV_LLAMACPP_GPU_LAYERS = "SINGULARITY_LLAMACPP_GPU_LAYERS"
ENV_LLAMACPP_CONTEXT_SIZE = "SINGULARITY_LLAMACPP_CONTEXT_SIZE"
ENV_LLAMACPP_CHAT_FORMAT = "SINGULARITY_LLAMACPP_CHAT_FORMAT"
ENV_LLAMACPP_NO_GRAMMAR = "SINGULARITY_LLAMACPP_NO_GRAMMAR"
ENV_LLAMACPP_EXTRA_ARGS = "SINGULARITY_LLAMACPP_EXTRA_ARGS"

# Optimization flags
ENV_SKIP_LLM_VERIFICATION = "SINGULARITY_SKIP_LLM_VERIFICATION"
ENV_LAZY_RERANKER = "SINGULARITY_LAZY_RERANKER"

# Database migrations
ENV_RUN_MIGRATIONS_ON_STARTUP = "SINGULARITY_RUN_MIGRATIONS_ON_STARTUP"

# Database connection pool
ENV_DB_POOL_MIN_SIZE = "SINGULARITY_DB_POOL_MIN_SIZE"
ENV_DB_POOL_MAX_SIZE = "SINGULARITY_DB_POOL_MAX_SIZE"
ENV_DB_COMMAND_TIMEOUT = "SINGULARITY_DB_COMMAND_TIMEOUT"
ENV_DB_ACQUIRE_TIMEOUT = "SINGULARITY_DB_ACQUIRE_TIMEOUT"

# Worker configuration (distributed task processing)
ENV_WORKER_ENABLED = "SINGULARITY_WORKER_ENABLED"
ENV_WORKER_ID = "SINGULARITY_WORKER_ID"
ENV_WORKER_POLL_INTERVAL_MS = "SINGULARITY_WORKER_POLL_INTERVAL_MS"
ENV_WORKER_MAX_RETRIES = "SINGULARITY_WORKER_MAX_RETRIES"
ENV_WORKER_HTTP_PORT = "SINGULARITY_WORKER_HTTP_PORT"
ENV_WORKER_MAX_SLOTS = "SINGULARITY_WORKER_MAX_SLOTS"
ENV_WORKER_CONSOLIDATION_MAX_SLOTS = "SINGULARITY_WORKER_CONSOLIDATION_MAX_SLOTS"
ENV_RETAIN_MAX_CONCURRENT = "SINGULARITY_RETAIN_MAX_CONCURRENT"

# Reflect agent settings
ENV_REFLECT_MAX_ITERATIONS = "SINGULARITY_REFLECT_MAX_ITERATIONS"
ENV_REFLECT_MAX_CONTEXT_TOKENS = "SINGULARITY_REFLECT_MAX_CONTEXT_TOKENS"
ENV_REFLECT_WALL_TIMEOUT = "SINGULARITY_REFLECT_WALL_TIMEOUT"
ENV_REFLECT_MISSION = "SINGULARITY_REFLECT_MISSION"
ENV_REFLECT_SOURCE_FACTS_MAX_TOKENS = "SINGULARITY_REFLECT_SOURCE_FACTS_MAX_TOKENS"
ENV_RECALL_INCLUDE_CHUNKS = "SINGULARITY_RECALL_INCLUDE_CHUNKS"
ENV_RECALL_MAX_TOKENS = "SINGULARITY_RECALL_MAX_TOKENS"
ENV_RECALL_CHUNKS_MAX_TOKENS = "SINGULARITY_RECALL_CHUNKS_MAX_TOKENS"

# Recall budget mapping (budget enum -> thinking_budget integer)
ENV_RECALL_BUDGET_FUNCTION = "SINGULARITY_RECALL_BUDGET_FUNCTION"
ENV_RECALL_BUDGET_FIXED_LOW = "SINGULARITY_RECALL_BUDGET_FIXED_LOW"
ENV_RECALL_BUDGET_FIXED_MID = "SINGULARITY_RECALL_BUDGET_FIXED_MID"
ENV_RECALL_BUDGET_FIXED_HIGH = "SINGULARITY_RECALL_BUDGET_FIXED_HIGH"
ENV_RECALL_BUDGET_ADAPTIVE_LOW = "SINGULARITY_RECALL_BUDGET_ADAPTIVE_LOW"
ENV_RECALL_BUDGET_ADAPTIVE_MID = "SINGULARITY_RECALL_BUDGET_ADAPTIVE_MID"
ENV_RECALL_BUDGET_ADAPTIVE_HIGH = "SINGULARITY_RECALL_BUDGET_ADAPTIVE_HIGH"
ENV_RECALL_BUDGET_MIN = "SINGULARITY_RECALL_BUDGET_MIN"
ENV_RECALL_BUDGET_MAX = "SINGULARITY_RECALL_BUDGET_MAX"

# Audit log settings
ENV_AUDIT_LOG_ENABLED = "SINGULARITY_AUDIT_LOG_ENABLED"
ENV_AUDIT_LOG_ACTIONS = "SINGULARITY_AUDIT_LOG_ACTIONS"
ENV_AUDIT_LOG_RETENTION_DAYS = "SINGULARITY_AUDIT_LOG_RETENTION_DAYS"

# Disposition settings
ENV_DISPOSITION_SKEPTICISM = "SINGULARITY_DISPOSITION_SKEPTICISM"
ENV_DISPOSITION_LITERALISM = "SINGULARITY_DISPOSITION_LITERALISM"
ENV_DISPOSITION_EMPATHY = "SINGULARITY_DISPOSITION_EMPATHY"
...
DEFAULT_OTEL_SERVICE_NAME = "singularity-memory"
...
class JsonFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        from singularity_memory_server.engine.memory_engine import _current_schema
...
def _parse_default_bank_template(raw: str | None) -> dict | None:
    """
    Parse SINGULARITY_DEFAULT_BANK_TEMPLATE as JSON.
...
class SingularityConfig:
    """Configuration container for Singularity Memory."""
    ...
    def validate(self) -> None:
        ...
        if self.llm_provider != "none" and self.retain_max_completion_tokens <= self.retain_chunk_size:
            raise ValueError(
                f"Invalid configuration: SINGULARITY_RETAIN_MAX_COMPLETION_TOKENS "
                f"({self.retain_max_completion_tokens}) must be greater than "
                f"SINGULARITY_RETAIN_CHUNK_SIZE ({self.retain_chunk_size}). "
                f"\n\nYou have two options to fix this:"
                f"\n  1. Increase SINGULARITY_RETAIN_MAX_COMPLETION_TOKENS to a value > {self.retain_chunk_size}"
...
_config_cache: SingularityConfig | None = None
...
def _get_raw_config() -> SingularityConfig:
    """
    ...
    if _config_cache is None:
        _config_cache = SingularityConfig.from_env()

"""
FastAPI server for Singularity Memory.

This module provides the ASGI app for uvicorn import string usage:
    uvicorn singularity_memory_server.server:app

For CLI usage, use the singularity-memory serve command instead.
"""
...
from singularity_memory_server.extensions import (
...
if __name__ == "__main__":
    ...
    from singularity_memory_server.main import main

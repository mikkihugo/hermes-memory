...
if TYPE_CHECKING:
    from singularity_memory_server.engine.interface import MemoryEngineInterface
...
class ExtensionContext(ABC):
    ...
    Built-in implementation:
        singularity_memory_server.extensions.builtin.context.DefaultExtensionContext
...
class DefaultExtensionContext(ExtensionContext):
    ...
    async def run_migration(self, schema: str) -> None:
        ...
        from singularity_memory_server.migrations import (

...
This extension allows external packages (like singularity-memory-cloud) to register
additional MCP tools on the Singularity Memory MCP server.

Example:
    SINGULARITY_MCP_EXTENSION=singularity_memory_cloud.extensions:CloudMCPExtension
"""

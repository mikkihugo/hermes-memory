...
class TenantExtension(Extension, ABC):
    ...
    Built-in implementation:
        singularity_memory_server.extensions.builtin.tenant.ApiKeyTenantExtension
    ...
    async def get_allowed_config_fields(self, context: RequestContext, bank_id: str) -> set[str] | None:
        ...
        Returns:
            ...
            Returned fields must be a subset of SingularityConfig.get_configurable_fields().
        """
        return None

"""
HTTP Extension for adding custom endpoints to the Singularity Memory.
...
class HttpExtension(Extension, ABC):
    ...
    Example:
        ```python
        from fastapi import APIRouter
        from singularity_memory_server.extensions import HttpExtension
    ...
    Configuration via environment variables:
        SINGULARITY_HTTP_EXTENSION=mypackage.ext:MyHttpExtension

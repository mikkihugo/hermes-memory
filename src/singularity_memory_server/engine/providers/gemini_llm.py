...
from singularity_memory_server.engine.llm_wrapper import parse_llm_json
...
from singularity_memory_server.worker.stage import set_stage
...
class GeminiLLM(LLMInterface):
    ...
    def _init_vertexai(self, **kwargs: Any) -> None:
        ...
        if not project_id:
            raise ValueError(
                "SINGULARITY_LLM_VERTEXAI_PROJECT_ID is required for Vertex AI provider. "
    ...
    async def call(
        ...
        for attempt in range(max_retries + 1):
            ...
            try:
                ...
                from singularity_memory_server.tracing import _serialize_for_span

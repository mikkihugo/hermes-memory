...
from singularity_memory_server.config import DEFAULT_LLM_TIMEOUT, ENV_LLM_TIMEOUT
    ...
    async def call(
        ...
        for attempt in range(max_retries + 1):
            ...
            try:
                ...
                # Record trace span
                from singularity_memory_server.tracing import _serialize_for_span, get_span_recorder

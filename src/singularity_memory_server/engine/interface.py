...
if TYPE_CHECKING:
    ...
    from singularity_memory_server.engine.response_models import RecallResult, ReflectResult
    from singularity_memory_server.engine.search.tags import TagsMatch
